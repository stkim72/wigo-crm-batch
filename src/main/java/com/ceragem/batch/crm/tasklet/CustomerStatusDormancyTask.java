...
/**
 * 
 * @ClassName	CustomerStatusDormancyTask
 * @author		김성태
 * @date		2022. 10. 5.
 * @Version		1.0
 * @description 휴면처리	
...
//@Slf4j
@Component
public class CustomerStatusDormancyTask implements Tasklet {
...
//		}
//
//		custService.batchDormancy(ymd);
		custService.executeDormancy();
