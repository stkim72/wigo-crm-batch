...
/**
 * 
 * @ClassName	SyncJadeEmpCeragemTasklet
 * @author		김성태
 * @date		2022. 10. 5.
 * @Version		1.0
 * @description	
...
@Slf4j
@Component
public class SyncJadeEmpCeragemTasklet implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		log.debug("SyncJadeEmpCeragemTasklet => empService.saveSyncCeragem()");
//		if (Utilities
...
//				empService.saveSyncCeragem(ymd);
