...
/**
 * 
 * @ClassName	GrdCoupn002IssueTask
 * @author		김성태
 * @date		2022. 10. 5.
 * @Version		1.0
 * @description	
...
@Slf4j
@Component
public class GrdCoupn002IssueTask implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		log.debug("GrdCoupn002IssueTask => grdCoupnIssueService.saveGrdCoupn()");
		
		GradeCouponVo gradeCouponVo = new GradeCouponVo();
		gradeCouponVo.setMshipGradeCd("002");
		int resultCnt = grdCoupnIssueService.saveGrdCoupn( gradeCouponVo );
		log.debug("GrdCoupn002IssueTask => pubish Copon Count = "+ resultCnt );
