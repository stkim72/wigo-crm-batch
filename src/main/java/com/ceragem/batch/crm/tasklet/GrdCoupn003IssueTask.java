...
/**
 * 
 * @ClassName	GrdCoupn003IssueTask
 * @author		김성태
 * @date		2022. 10. 5.
 * @Version		1.0
 * @description	
...
@Slf4j
@Component
public class GrdCoupn003IssueTask implements Tasklet {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		log.debug("GrdCoupn003IssueTask => grdCoupnIssueService.saveGrdCoupn()");
		
		GradeCouponVo gradeCouponVo = new GradeCouponVo();
		gradeCouponVo.setMshipGradeCd("003");
		int resultCnt = grdCoupnIssueService.saveGrdCoupn( gradeCouponVo );
		log.debug("GrdCoupn003IssueTask => pubish Copon Count = "+ resultCnt );
